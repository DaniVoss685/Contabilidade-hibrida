-- ==============================================================================
-- MIGRATION: 20260917_25_consulting_portfolio_rbt12_fs12.sql
-- DESCRIÇÃO: Atualiza a RPC get_consulting_portfolio_summary para calcular
--            RBT12 (12 meses anteriores) e FS12 (Folha dos 12 meses anteriores)
--            com base oficial em accounting_monthly_snapshots (ou dados cadastrais),
--            determinando o Fator R real, enquadramento Anexo III vs V e alíquota efetiva.
-- ==============================================================================
...
BEGIN
    ...
    -- 2. Iterar sobre os tenants reais ativos
    FOR r_tenant IN
        SELECT 
            t.id AS tenant_id,
            COALESCE(
